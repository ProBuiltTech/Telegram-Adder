...
# Code Coded And Design By ProBuilt Tech
# ===========================================


Print(f'''
======================================================
Telegram Scraping Sofware Created By ProBuilt Tech
======================================================
''')
re="\033[1;31m"
gr="\033[1;32m"
...
def update_tool():
    ...
    banner()
    source = r.get("https://github.com/ProBuiltTech/Telegram-Adder.git")
    if source.text == '3':
        ...
        os.system("""
        curl -s -O https://github.com/ProBuiltTech/Telegram-Adder/main/groupadd.py
        curl -s -O https://github.com/ProBuiltTech/Telegram-Adder/main/scraper.py
        curl -s -O https://github.com/ProBuiltTech/Telegram-Adder/main/setup.py
        curl -s -O https://github.com/ProBuiltTech/Telegram-Adder/main/smsbot.py
        chmod 777 *.py
        """);time.sleep(1)
